...
<div class="container py-4">
	<div class="row">
		<main class="col-lg-8 main-content">
			<h2 class="d-md-none d-block text-uppercase text-center"><?php echo $product['name'];?></h2>
			<p><?php echo $product['description'];?></p>
		</main>

		<aside class="col-lg-4 pt-4 pt-lg-0 product_description">
            <h3 class="text-uppercase text-center mt-5">Description</h3>
            <p class="lead text-center p-3"><?php echo $product['short_description'];?></p>

            <h3 class="text-uppercase text-center mt-2">Price</h3>
            <p class="display-4 lead text-center p-3"><?php echo $product['price'];?>€</p>
        </aside>
	</div>
</div>
